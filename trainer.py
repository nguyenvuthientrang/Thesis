...
class Attacker():
    def __init__(self, args, seed, metric_keys, save_keys):
        ...
        self.outter, self.train_target = get_datasets(args, Dataset, Dataset, tasks=self.tasks, resize_imnet=resize_imnet, seed=self.seed, phase='trigger_gen')
    ...
    def train_surrogate(self, avg_metrics):
    ...
    def trigger_generating(self, trigger=None, dim=100):
        ...
        save_name = trigger_save_dir + time.strftime("%m-%d-%H_%M_%S",time.localtime(time.time())) 
